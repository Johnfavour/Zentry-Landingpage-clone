...
const Features = () => {
  return (
    <section className="bg-black pb-52">
        ...
        <BentoTilt className="border-hsla relative mb-7 h-96 wifull overflow-hidden
        rounded-md md:h-[65vh]">
            <BentoCard
                src="videos/feature-1.mp4"
                title={<>radia<b>n</b>t</>}
                description="A cross-platform metagame app, turning your
                activitiesacross Web2 and Web3 games into a rewarding adventure."
            />
        </BentoTilt>
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
            ...
            <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
                <BentoCard
                    ...
                    title={<>n<b>e</b>xus</>}
                    description="A gamified social hub, adding a new dimension of play to social interaction for Web communities."
                />
            </BentoTilt>
            <BentoTilt className="bento-tilt_1 me:14 md:col-span-1 md:me-0">
                <BentoCard
                    ...
                    title={<>az<b>u</b>l</>}
                    description="A cross-world AI Agent - elevating your gameplay to be more fun and protective."
                />
            </BentoTilt>
